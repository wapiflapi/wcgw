...
export const defaultModelInput: ModelInput = {
  ...
  impactRestitutionCoefficientTolerance_ratio: 0.2,
  impactFrictionCoefficient_ratio: 0.35,
  impactFrictionCoefficientTolerance_ratio: 0.2,
  spinTransferEfficiency_ratio: 0.3,
  spinTransferEfficiencyTolerance_ratio: 0.25,
  drumComplianceFactor_ratio: 1,
  drumComplianceFactorTolerance_ratio: 0.3,
}
