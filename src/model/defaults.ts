...
export const defaultModelInput: ModelInput = {
  ...
  trackAngle_rad: inputValue(degToRad(30)),
  trackLength_m: inputValue(1),
  releasePoint_x_m: inputValue(0),
  releasePoint_y_m: inputValue(0),
  impactPoint_x_m: inputValue(0.8),
  impactPoint_y_m: inputValue(0),
  drumSurfaceAngle_rad: inputValue(degToRad(8.6)),
  drumPivotPoint_x_m: inputValue(0),
  drumPivotPoint_y_m: inputValue(0.2),
  drumPivotAngle_rad: inputValue(0),

  gravity_mps2: inputValue(9.81),
  marbleDensity_kgpm3: inputValue(7850),
  rollingInertiaFactor_ratio: inputValue(0.4),
  staticFrictionCoefficient_ratio: inputValue(0.5),
  trackEnergyEfficiency_ratio: inputValue(0.95),
